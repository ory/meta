...
[discussion]($DISCUSSIONS) first** so we can align on the problem and the
...
[open a well-written issue or discussion](https://github.com/$REPOSITORY/issues):
...
**Please open an issue or [discussion]($DISCUSSIONS) before you write any code,
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Conventional Commits configuration](https://github.com/$REPOSITORY/blob/master/.github/workflows/conventional_commits.yml)
...
maintain the quality and reliability of Ory $PROJECT, please follow these
guidelines:
...
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/$REPO_NAME.git
