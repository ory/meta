...
in Ory $PROJECT, please responsibly disclose by contacting us at security@ory.sh.
...
[docs](https://github.com/$REPOSITORY/tree/master/docs) folder. Generate API and configuration reference documentation using
`cd docs; npm run gen`.

For further instructions please head over to [docs/README.md](https://github.com/$REPOSITORY/blob/master/README.md).
